                ...
                try {
                    ...
                    if ($null -ne $commandResponse -and $commandResponse.command) {
                        ...
                        switch ($commandResponse.command) {
                            "START_SCAN" {
                                if ($null -ne $Script:ActiveScanJob) {
                                    Write-Log -Message "Ein Scan lÃ¤uft bereits. Ignoriere neuen START_SCAN Befehl."
                                }
                                else {
                            ...
                            "UPDATE_CLIENT" {
                                if ($null -ne $Script:ActiveScanJob) {
                                    Write-Log -Message "Ein Scan lÃ¤uft derzeit. Ignoriere UPDATE_CLIENT bis zum Abschluss."
                                }
                                else {
